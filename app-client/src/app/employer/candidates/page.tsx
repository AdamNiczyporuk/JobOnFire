...
export default function EmployerCandidatesPage() {
  ...
  useEffect(() => {
    fetchCandidates();
  }, [page, searchQuery, experienceFilter, skillsFilter, placeFilter, educationFilter]);
  ...
  const fetchCandidates = async () => {
    try {
      ...
      if (searchQuery) {
        // Używamy skills filter do ogólnego wyszukiwania
      ...
      if (placeFilter) filters.place = placeFilter;
      if (educationFilter) filters.education = educationFilter;
              ...
              <aside className="rounded-lg border bg-white p-4 h-fit"> 
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => { setEducationFilter(e.target.value); setPage(1); }}
                ...
                {/* Reset filters */}
                {(experienceFilter || skillsFilter || placeFilter || educationFilter) && (
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => {
              ...
              <div className="space-y-4">
                {candidates.map((candidate) => (
                  <Link
                    ...
                    className="block rounded-lg border bg-white p-4 shadow-sm transition-colors duration-150 hover:bg-accent/30 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer"
                  >
