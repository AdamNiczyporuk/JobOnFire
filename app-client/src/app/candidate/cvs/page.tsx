...
export default function CandidateCVsPage() {
  ...
  const [previewCV, setPreviewCV] = useState<any | null>(null); // Stan dla podgl¹du wygenerowanego CV
  ...
  const confirmDelete = async () => {
    ...
    try {
      console.log('Calling candidateService.deleteCV...');
      await candidateService.deleteCV(cvId);
      console.log('Delete successful, refreshing list...');
      
      // Po soft delete prze³aduj listê z serwera, ¿eby UI by³ zgodny z backendem
      ...
      const errorMessage = error.response?.data?.message || 'Nie uda³o siê usun¹æ CV.';
      alert(errorMessage);
    } finally {
  ...
  const handleOpenPreview = async (cvId: number) => {
    try {
      ...
      // Jeœli to wygenerowane CV (bez cvUrl)
      if (data.type === 'generated' && data.cvData) {
        setPreviewCV(data.cvData);
        return;
      }
      
      // Jeœli to CV z URL (Cloudinary)
  ...
  if (!user) {
    return (
      <main className="flex-1 w-full flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-600">Sprawdzanie uprawnieñ...</p>
        <p className="text-sm text-gray-500 mt-2">Przekierowanie na stronê logowania</p>
      </main>
    );
  }
  ...
  if (user.role !== "CANDIDATE") {
    return (
      <main className="flex-1 w-full flex flex-col items-center justify-center py-12">
        ...
        <p className="text-red-600">Brak dostêpu do panelu kandydata</p>
        <p className="text-sm text-gray-500 mt-2">Przekierowanie na stronê g³ówn¹</p>
      </main>
    );
  }
  ...
  return (
    <>
      {/* Modal podgl¹du wygenerowanego CV */}
      {previewCV && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg shadow-2xl w-[95vw] h-[95vh] mx-4 flex flex-col animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex items-center justify-between p-4 border-b">
              <h3 className="text-lg font-semibold">Podgl¹d CV</h3>
              <Button
                variant="ghost"
                size="sm"
                onClick={() => setPreviewCV(null)}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Czy na pewno chcesz usun¹æ CV <span className="font-semibold">"{cvToDelete.name}"</span>? 
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Zarz¹dzaj swoimi CV i dokumentami aplikacyjnymi
          </p>
        </div>
      ...
      <div className="bg-white rounded-lg border">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Nie masz jeszcze ¿adnego CV</h3>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Przechowuj ró¿ne wersje CV dopasowane do konkretnych stanowisk. 
                To zwiêkszy Twoje szanse na zatrudnienie!
              </p>
            </div>
          </div>
        </div>
